  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between">
        <h3 className="font-semibold text-foreground">Batch Queue ({items.length})</h3>
        <button
          onClick={onClearAll}
          ...
          {items.map((item) => (
            ...
            >
              ...
              <div className="flex items-start justify-between gap-2 mb-2">
                <p className="text-xs font-semibold text-foreground truncate flex-1">{item.fileName}</p>
                ...
                <button
                  ...
                  className="text-muted-foreground/80 hover:text-[#EF4444] transition-colors"
                >
      ...
      <div className="flex gap-2">
        ...
        {pendingCount > 0 && onProcessQueue && !isProcessing && (
          <Button
            ...
            className="flex-1 bg-primary hover:bg-[#E63E1D] text-white rounded-xl h-10"
          >
