      ...
      >
        {["Indian passport spec", "White background", "35×45 mm crop", "Print-ready output"].map((tag, idx) => (
          <motion.span 
            ...
            className="flex items-center gap-1.5 rounded-full border border-border bg-muted/40 px-4 py-2 text-sm text-foreground/70 hover:border-success-500/30 hover:bg-white transition-all cursor-default"
          >
