      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {badges.map((badge, idx) => {
          ...
          return (
            ...
            >
              <Card className="border-slate-200/60 bg-white/70 backdrop-blur-md h-full hover:shadow-[0_15px_30px_-10px_rgba(0,0,0,0.05)] hover:border-primary/20 transition-all duration-300 hover:-translate-y-1 rounded-3xl">
                <CardHeader className="pb-2 pt-6 px-6">
                  ...
                  <CardTitle className="text-lg font-bold leading-snug text-foreground">{badge.label}</CardTitle>
                </CardHeader>
