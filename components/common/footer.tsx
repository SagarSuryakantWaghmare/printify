...
const socialLinks: SocialLink[] = [
  { label: "Twitter", href: "https://twitter.com/printfy", icon: XIcon },
  { label: "GitHub", href: "https://github.com/printfy", icon: GitHubIcon },
  { label: "LinkedIn", href: "https://linkedin.com/company/printfy", icon: LinkedInIcon },
]
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 md:px-8 md:py-16">
          ...
          <div className="md:col-span-2 space-y-4">
            <Link href="/" className="flex items-center gap-2 group w-fit">
              <motion.div 
                ...
                className="flex h-9 w-9 items-center justify-center rounded-lg bg-primary shadow-lg group-hover:shadow-xl transition-shadow"
              >
        ...
        >
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              <h3 className="text-lg font-bold text-foreground mb-1">Stay updated</h3>
        ...
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 md:px-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 text-sm text-muted-foreground">
            ...
            <div className="flex items-center gap-6">
              <Link href="mailto:support@printfy.app" className="hover:text-primary transition-colors flex items-center gap-1">
